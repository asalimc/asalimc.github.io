...
const urlsToCache = [
  './',
  './index.html',
  './offline.html',  // Make sure to create this file
...
// Fetch with Network First strategy (online preferred)
          ...
          .then(cachedResponse => {
            ...
            if (acceptHeader.includes('text/html')) {
              return caches.match('./offline.html')
                .then(offlinePage => offlinePage || new Response('Offline - SBO Sistem', {
                  status: 503,
